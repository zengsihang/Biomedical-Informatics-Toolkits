...
def find_knn(pool, query, args, use_multi_gpu=False, exact=False):
    '''
    ...
    if not exact:
        ...
        gpu_index = faiss.index_cpu_to_gpu(res, args.use_gpu_index, index)
    ...
    similarity, indices = gpu_index.search(query, args.k*2)
